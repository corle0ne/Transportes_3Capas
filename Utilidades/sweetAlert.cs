...
namespace Transportes_3Capas.Utilidades
{
    public class sweetAlert
    {
        public static void Sweet_Alert(string title, string msg, string type, Page pg, Object obj)
        {
            ...
            //Type hace referencia al tipo de objeto que voy a trabjar
            Type cstype = obj.GetType();
            //ClientScriptManager me ayuda a incrustar bloques de codigo de JS en timpo real dentro de formulario
